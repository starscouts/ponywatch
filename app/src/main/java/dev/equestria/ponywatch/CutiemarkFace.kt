 ...
 */
class CutiemarkFace : CanvasWatchFaceService() {

    override fun onCreateEngine(): Engine {
        return Engine()
    }

    private class EngineHandler(reference: CutiemarkFace.Engine) : Handler(Looper.myLooper()!!) {
        private val mWeakReference: WeakReference<CutiemarkFace.Engine> = WeakReference(reference)
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(
                WatchFaceStyle.Builder(this@CutiemarkFace)
        ...
        private fun registerReceiver() {
            ...
            this@CutiemarkFace.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@CutiemarkFace.unregisterReceiver(mTimeZoneReceiver)
        }
