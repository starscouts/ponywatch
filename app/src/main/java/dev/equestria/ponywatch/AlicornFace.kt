 ...
 * https://codelabs.developers.google.com/codelabs/watchface/index.html#0
 */
class AlicornFace : CanvasWatchFaceService() {

    override fun onCreateEngine(): Engine {
        return Engine()
    }

    private class EngineHandler(reference: AlicornFace.Engine) : Handler(Looper.myLooper()!!) {
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(
                WatchFaceStyle.Builder(this@AlicornFace)
        ...
        private fun initializeBackground() {
            ...
            mBackgroundBitmap =
                BitmapFactory.decodeResource(resources, R.drawable.watchface_alicorn_bg)
        }
        ...
        private fun registerReceiver() {
            ...
            this@AlicornFace.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@AlicornFace.unregisterReceiver(mTimeZoneReceiver)
        }
